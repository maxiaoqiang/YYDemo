//
//  MXQTextEditExample.m
//  YYDemo
//
//  Created by 深圳市泥巴装网络科技有限公司 on 2017/4/30.
//  Copyright © 2017年 马晓强. All rights reserved.
//

#import "MXQTextEditExample.h"

@interface MXQTextEditExample ()<YYTextViewDelegate,YYTextKeyboardObserver>
...
@implementation MXQTextEditExample
...
-(void)initImageView{
    ...
    UIPanGestureRecognizer *g = [[UIPanGestureRecognizer alloc] initWithActionBlock:^(UIPanGestureRecognizer *g) {
        ...
        UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:imageView.frame cornerRadius:self.imageView.layer.cornerRadius];
        self.textView.exclusionPaths=@[path];
