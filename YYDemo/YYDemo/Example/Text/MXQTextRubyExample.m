...
#import "MXQTextRubyExample.h"

@interface MXQTextRubyExample ()

@end

@implementation MXQTextRubyExample
...
- (void)viewDidLoad {
    ...
    label.height = self.view.height -(kiOS7Later?64:0);
    label.top = (kiOS7Later?64:0)+30;
    label.textAlignment = NSTextAlignmentCenter;
    label.textVerticalAlignment = YYTextVerticalAlignmentCenter;
    label.numberOfLines = 0;
    label.backgroundColor = [UIColor colorWithWhite:0.933 alpha:1.0];
