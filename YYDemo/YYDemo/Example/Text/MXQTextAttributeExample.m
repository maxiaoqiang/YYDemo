...
#import "MXQTextAttributeExample.h"

@interface MXQTextAttributeExample ()

@end

@implementation MXQTextAttributeExample
...
- (void)viewDidLoad {
    ...
    {
        NSMutableAttributedString *one = [[NSMutableAttributedString alloc] initWithString:@"Multiple Shodows"];
        one.font = [UIFont boldSystemFontOfSize:30];
    ...
    }
    {
        ...
        UIImage *background = [UIImage imageWithSize:size drawBlock:^(CGContextRef  _Nonnull context) {
            ...
            UIColor *c1 = [UIColor colorWithRed:0.869 green:1.000 blue:0.030 alpha:1.00];
            [c0 setFill];
    ...
    
    {
        ...
        one.font = [UIFont boldSystemFontOfSize:30];
        one.color = [UIColor colorWithRed:1.00 green:0.029 blue:0.651 alpha:1.000];
    ...
    
    {
        ...
        [one setTextHighlightRange:one.rangeOfAll color:[UIColor colorWithRed:0.093 green:0.492 blue:1.000 alpha:1.00] backgroundColor:[UIColor colorWithWhite:0.000 alpha:0.220] tapAction:^(UIView * _Nonnull containerView, NSAttributedString * _Nonnull text, NSRange range, CGRect rect) {
    ...
    label.backgroundColor = [UIColor colorWithWhite:0.933 alpha:1.00];
